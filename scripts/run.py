#!/usr/bin/env python
"""Train and evaluate one method on self-generated ProsQA.

    python scripts/run.py --method reverie --steps 3000 --hops 4

Train, val and test each come from their own generator seed. The vocab is built
from the generated data, and with --out the test metrics land in a JSON blob.
"""
...
def main():
    ...
    # eval time rather than retraining per compute budget.
    pareto = []
