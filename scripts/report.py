#!/usr/bin/env python
"""Print markdown result tables from run JSONs.

    python scripts/report.py runs/matrix.json runs/reverie_s0.json

A matrix.json gives the method comparison table. A single-run JSON gives per-hop
accuracy with mean latent steps, plus the halt sweep if the run recorded one.
"""
