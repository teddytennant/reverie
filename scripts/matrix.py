#!/usr/bin/env python
"""Run the method comparison matrix and write a markdown results table.
...
compute over one or more seeds, then aggregates test accuracy, latent steps used
and calibration ρ into a JSON blob and a markdown table. Each run is a separate
subprocess with its own JAX state; results come back through its --out JSON.
"""
